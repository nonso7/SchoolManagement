  ...
  const registerStudent = async () => {
    ...
    try {
      const tx = await contract.registerStudent(
        ethers.BigNumber.from(id), // Ensure ID is in correct format
        name,
        ethers.BigNumber.from(age) // Ensure Age is in correct format
      );
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
      ...
      <div className="mt-4 w-full max-w-md">
        {students.map((student, index) => (
          <div key={index} className="bg-white p-4 mb-2 rounded shadow-md">
